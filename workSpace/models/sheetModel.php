...
class SheetModel extends modelManager
{
    public function getListEntities(){
        $sql = 'select t1.e_id entity_id, t1.e_type entity_type, t1.created created, l2.likes_count likes_count, notown.entity_user_id not_owner_entity_user_id, e2.reposts_count reposts_count,
